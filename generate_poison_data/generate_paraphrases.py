...
templates = [
            #'( ROOT ( S ( NP ) ( VP ) ( . ) ) ) EOP'   #done
            #'( ROOT ( S ( VP ) ( . ) ) ) EOP'
            #'( ROOT ( NP ( NP ) ( . ) ) ) EOP', #ing
            #'( ROOT ( FRAG ( SBAR ) ( . ) ) ) EOP',
            #'( ROOT ( S ( S ) ( , ) ( CC ) ( S ) ( . ) ) ) EOP',    done
            #'( ROOT ( S ( LST ) ( VP ) ( . ) ) ) EOP',
            #'( ROOT ( SBARQ ( WHADVP ) ( SQ ) ( . ) ) ) EOP' #    done
            #'( ROOT ( S ( PP ) ( , ) ( NP ) ( VP ) ( . ) ) ) EOP',
            #'( ROOT ( S ( ADVP ) ( NP ) ( VP ) ( . ) ) ) EOP'  #done
            #'( ROOT ( S ( SBAR ) ( , ) ( NP ) ( VP ) ( . ) ) ) EOP' #done
    ]
...
if __name__ == '__main__':
    ...
    rev_label_voc = dict((v,k) for (k,v) in list(parse_gen_voc.items())) 
